...
<div class="container">
    ...
    <div class="mb-3 d-flex align-items-center">
        <a href="{{ route('movies.index', ['type' => 'popular', 'page' => 1, 'category' => $categoryId]) }}" class="btn btn-primary mr-2">Popular</a>
        <a href="{{ route('movies.index', ['type' => 'alphabetical', 'page' => 1, 'category' => $categoryId]) }}" class="btn btn-secondary mr-2">Alfabeticamente</a>
